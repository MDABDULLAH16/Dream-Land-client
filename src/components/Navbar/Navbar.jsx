...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      <NavLink
        to="/"
        className="block py-2 pl-3 pr-4 border-b border-transparent lg:border-0 lg:p-0 text-neutral hover:bg-accent/20 lg:hover:bg-transparent lg:hover:text-primary transition-colors"
      >
        Home
      </NavLink>
